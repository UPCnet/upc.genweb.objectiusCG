...
from upc.genweb.objectiusCG.interfaces import IObjectiuGeneralCG

from plone.memoize.instance import memoize

class ObjectiuGeneralView(BrowserView):
    ...
    __call__ = ViewPageTemplateFile('objectiuGeneralCG-view.pt')
